...
🛠 Worked on ERP modules, backend logic, database handling, and API integration
💻 Built and worked on projects involving web applications, backend systems, and real-world use cases
🔧 Comfortable with Git, GitHub, Pull Requests, and collaborative development
💞️ Open to collaborating on backend-heavy, full-stack, and startup/open-source projects
